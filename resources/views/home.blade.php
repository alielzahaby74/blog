      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-12 mx-lg-4">
          ...
          <section class="classic-blog-listing">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('post') }}" >
              @csrf
              <input type="hidden" value="{{auth()->user()->id}}" name="user_id">
              <textarea placeholder="What's on your mind!"
              style="width:100%; height:150px; resize:none;" name = "post_content">
              </textarea>
              <!--class="fas fa-camera-retro"-->
              <input type="file" name="post_thumbnail" class="form-control-file">
              <div class="d-flex justify-content-between">
                <input type="text" name="tag" style="height: 30px">
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-12">
                ...
                <!-- Excerpt -->
                <a>
                  <p class="text-center font-weight-bold gold-text mt-4">{{ $post->post_tag }}</p>
                </a>
                ...
                <p class="dark-grey-text">{{$post->post_content}}
                </p>

                <div class="text-center pb-2">
                  <a class="btn btn-transparent btn-sm font-weight-bold btn-rounded dark-grey-text">Read more</a>
                </div>
                ...
                <div class="post-data mt-3 pt-3 grey-text">
                  <h6>By
                    <a href="#!" class="gold-text">{{ $post->user_id }}</a> on 25/08/2016
                    <a href="#!" class="dark-grey-text">
                      <i class="far fa-comments pr-2 pl-3"></i>149</a>
                  </h6>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-12">
                ...
                <!-- Image -->
                <div class="view overlay z-depth-1 mb-3">
                  <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/8-col/img%20%28122%29.jpg"
                    class="img-fluid">
                  <a href="#!">
                    <div class="mask rgba-white-slight"></div>
                  </a>
                ...
                <!-- Excerpt -->
                <a>
                  <p class="text-center font-weight-bold gold-text mt-4">NATURE</p>
                </a>
                ...
                <p class="dark-grey-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                  doloremque
                ...
                <div class="post-data mt-3 pt-3 grey-text">
                  <h6>By
                    <a href="#!" class="gold-text">{{ auth()->user()->name }}</a> on 25/08/2016
                    <a href="#!" class="dark-grey-text">
                      <i class="far fa-comments pr-2 pl-3"></i>149</a>
                  </h6>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-12">
                ...
                <div class="post-data mt-3 pt-3 grey-text">
                  <h6>By
                    <a href="#!" class="gold-text">Martha Barnett</a> on 25/08/2016
                    <a href="#!" class="dark-grey-text">
                      <i class="far fa-comments pr-2 pl-3"></i>149</a>
                  </h6>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-12">
                ...
                <!-- Image -->
                <div class="view overlay z-depth-1 mb-3">
                  <img src="https://mdbootstrap.com/img/Photos/Horizontal/City/8-col/img%20%2848%29.jpg"
                    class="img-fluid">
                  <a href="#!">
                    <div class="mask rgba-white-slight"></div>
                  </a>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-12">
                ...
                <!-- Image -->
                <div class="view overlay z-depth-1 mb-3">
                  <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/8-col/img%20%28115%29.jpg"
                    class="img-fluid">
                  <a href="#!">
                    <div class="mask rgba-white-slight"></div>
                  </a>
        ...
        <div class="col-lg-3 col-12 px-4 blue-grey lighten-5">
          ...
          <section class="mb-4">
            ...
            <div class="flex-center mt-4">
              <img src="https://mdbootstrap.com/img/Photos/Avatars/img (32).jpg" class="img-fluid img-author z-depth-1">
            </div>
